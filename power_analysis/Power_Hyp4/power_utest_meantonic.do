...
sum mg_relative_meantonic  mg_m_valence mg_m_valencesq
  
  
regress mg_relative_meantonic  mg_m_valence mg_m_valencesq if treatment=="Equal" & ind_obs==1 ,  noconstant
...
program simregress, rclass
    ...
    syntax, n(integer)          /// Sample size
          [alpha(real 0.05)    /// Alpha level
           mg_valence(real 0.706)       /// I use the value in the regression for Equal treatment ---> evidence for a U-shaped 
