...
sum mg_relative_edasymp  mg_m_valence mg_m_valencesq
  
  
regress mg_relative_edasymp  mg_m_valence mg_m_valencesq if treatment=="Equal" & ind_obs==1 ,  noconstant
...
program simregress, rclass
    ...
    syntax, n(integer)          /// Sample size
          [alpha(real 0.05)    /// Alpha level
           mg_valence(real 30)       /// I use the value in the regression for Equal treatment ---> evidence for a U-shaped 
		   mg_valencesq(real 296) ///
             esd(real 2.77) ]      //  Standard deviation of the error
    quietly {
		...
		*I use the value for the entire sample
        ...
        generate edasymp =  `mg_valence'*mg_m_valence + `mg_valencesq'*mg_m_valencesq + e
        // TEST THE NULL HYPOTHESIS
        regress edasymp  mg_m_valence mg_m_valencesq
        utest  mg_m_valence mg_m_valencesq
...
power simregress, n(300(50)500)  alpha(0.05) 
